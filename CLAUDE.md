...
**Дорожная карта:**
1. Редизайн визуала (по референсам tasteskill.dev) — текущий этап
2. Схема Supabase + Auth + RLS (роли/права)
3. Подключение Supabase: чтение данных, авторизация
4. CRUD (проекты, люди, назначения, выравнивание загрузки, realtime)
5. Экспорт в Excel + синк в Smartsheet из Supabase
6. Кросс-направленческая загрузка, статусы, дедлайны
